...
namespace PrjPropertyRentalManagementWebSite.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UseName,Password,UserID,Role")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UseName,Password,UserID,Role")] User user)
        {
            if (ModelState.IsValid)
            {
